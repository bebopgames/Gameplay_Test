...
namespace cdp_framework
{
	...
	public:
		...
		virtual void RenderTextRightAligned( const std::string& text, const Vector2& position, float scale, const FXMVECTOR& color = Colors::White ) = 0;
		virtual void RenderTextCentered( const std::string& text, const Vector2& position, float scale, const FXMVECTOR& color = Colors::White ) = 0;
