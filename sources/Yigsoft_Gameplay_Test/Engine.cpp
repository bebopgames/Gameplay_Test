...
namespace cdp_framework
{
	...
	void Engine::Render()
	{
		...
		// Draw a consistent grid on the dark-grey ground, ceiling, and walls.
		const XMVECTORF32 horizontalAxis = { 21.f, 0.f, 0.f };
		const XMVECTORF32 depthAxis = { 0.f, 0.f, 21.f };
		const XMVECTORF32 verticalAxis = { 0.f, 13.f, 0.f };
		const XMVECTORF32 floorOrigin = { 0.f, 0.01f, 0.f };
		const XMVECTORF32 ceilingOrigin = { 0.f, 25.99f, 0.f };
		const XMVECTORF32 leftWallOrigin = { -21.99f, 13.f, 0.f };
		const XMVECTORF32 rightWallOrigin = { 21.99f, 13.f, 0.f };
		const XMVECTORF32 nearWallOrigin = { 0.f, 13.f, -21.99f };
		const XMVECTORF32 farWallOrigin = { 0.f, 13.f, 21.99f };
		DrawGrid( horizontalAxis, depthAxis, floorOrigin, 21, 21, Colors::Gray );
		DrawGrid( horizontalAxis, depthAxis, ceilingOrigin, 21, 21, Colors::Gray );
		DrawGrid( depthAxis, verticalAxis, leftWallOrigin, 21, 13, Colors::Gray );
		DrawGrid( depthAxis, verticalAxis, rightWallOrigin, 21, 13, Colors::Gray );
		DrawGrid( horizontalAxis, verticalAxis, nearWallOrigin, 21, 13, Colors::Gray );
		DrawGrid( horizontalAxis, verticalAxis, farWallOrigin, 21, 13, Colors::Gray );
